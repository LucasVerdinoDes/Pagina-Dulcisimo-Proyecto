...
router.post('/', async (req, res, next) => {
    ...
    var obj = {
        ...
        subject: 'Inscripción Pre-A',
        html: "Informacion del menor ------ Nombre y apellido: " + nombre + " " + apellido + " --- Edad: " + edad + "  --- Colegio: " + colegio + "  --- Grado/Año: " + grado + "  ------ Datos del adulto responsable ------- Nombre y Apellido: " + nombre2 + " " + apellido2 + "  --- Parentesco: " + parentesco + "  --- Celular: " + celular + "  --- Barrio: " + barrio + "  --- Email: " + email + " Ficha adjunta: " + formFile ,
